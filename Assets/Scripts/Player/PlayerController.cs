...
public class PlayerController : MonoBehaviour
{
    ...
    public float ledgeClimbXOffset4 = 0f;
    ...
    private void CheckLedgeClimb()
    {
        if (ledgeDetected && !canClimbLedge)
        {
            ...
            {
                ledgePos2 = new Vector2(Mathf.Ceil(ledgePosBot.x - wallCheckDistance) + ledgeClimbXOffset1, Mathf.Floor(ledgePosBot.y) + ledgeClimbXOffset1);
    ...
    {
        amountOfDashLeft--;
        GameUIScript.SetDash(amountOfDashLeft);
        isDashing = true;
    ...
    {
        if ((amountOfDashLeft == 0 && Time.time > lastDash + dashCoolDown) || Time.time > lastDash + dashCoolDown)
        {
            GameUIScript.SetMaxDash(amountOfDash);
    ...
    // isWallSliding || isTouchingWall )&& movementInputDirection != 0 && canNormalJump
